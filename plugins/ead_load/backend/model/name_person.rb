class NamePerson < Sequel::Model(:name_person)
  ...
  #
  #  if self[:source_id]
  #    validates_unique([:title, :source_id, :prefix, :primary_name, :rest_of_name], :message => "Agent must be unique")
  #  else
  #    validates_unique([:title, :prefix, :primary_name, :rest_of_name], :message => "Agent must be unique")
  #  end
  #
  #  validates_unique([:source_id, :authority_id], :message => "Agent identifier must be unique within source")
  #  map_validation_to_json_property([:vocab_id, :source_id, :authority_id], :authority_id)
  #  map_validation_to_json_property([:title, :prefix, :primary_name, :rest_of_name], :primary_name)
  #  map_validation_to_json_property([:title, :prefix, :primary_name, :rest_of_name, :source_id], :primary_name)
  #end
end
